      ...
      <section class="border-1 mb-5">
        ...
        <Transition name="smooth" mode="out-in">
          <div v-if="show1" class="form-content">
            ...
            <div class="row m-2">
              <label
                class="col-2 col-md-3 col-sm-4 text-end align-self-center"
                for="projectOnChainAddress"
              >
              ...
              <input
                type="text"
                class="form-controls col-10 col-md-9 col-sm-8"
                id="projectOnChainAddress"
                v-model="projectOnChainAddress"
              />
            </div>
          </div>
        </Transition>
      ...
      <section class="border-1 mb-5">
        ...
        <Transition name="smooth" mode="out-in">
          <div v-if="show3" class="form-content">
            ...
            <div class="row mx-2 my-4">
              <label class="col-1 text-end align-self-center" for="discord"> Discord</label>
      ...
      <section class="border-1 mb-3">
        ...
        <Transition name="smooth" mode="out-in">
          <div v-if="show4" class="form-content">
            ...
            <div class="row m-2">
              <label for="document" class="col-2 col-md-3 col-sm-4 text-end align-self-center"
                >Whitepaper</label
              >
              <input
                type="file"
