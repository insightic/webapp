<template>
  <div style="max-width: 960px" class="comment px-3">
    ...
    <SectionLayout title="Basic Information">
      <LabelTextareaComponent label="Comments on Project Name" :rows=2 type="text" v-model:field="name"/>
      ...
      />
      <LabelTextareaComponent label="Comments on Project Description" :rows=2 v-model:field="desc"/>
    ...
    <button type="button" class="btn btn-primary" @click="commentPanel = true">Save Comments</button>
  </div>
</template>
