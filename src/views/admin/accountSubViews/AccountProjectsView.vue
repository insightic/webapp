<template>
  <div class="text-secondary mb-4 d-flex justify-content-between align-items-center">
    ...
    <div class="icon-btn">
      ...
      <!-- show card -->
      <i
        class="bi bi-grid-3x3-gap npmme-3"
        style="font-size: 1.5rem"
  ...
  data() {
    return {
      ...
      icons: {
        ...
        olympus:
          'https://yt3.googleusercontent.com/pAzCW6e1kfAi2HOSS0B9DVCzn3Hi2ciYRNii2V6JtgJiLTiNsW-bRWZjfgOiqQf3sx_0QB2Ymg=s900-c-k-c0x00ffffff-no-rj',
        'euler finance':
          'https://storage.googleapis.com/subgraph-images/1656114240805euler-transparent.png',
